...
<div id="wrapper">
    ...
    <div id="main">
        ...
        <header id="header">
            ...
            <a href="wordServlet?type=insert"><span class="label">增加单词</span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <form action="wordServlet?type=like" method="post">
                ...
                <button type="submit" style="background:transparent;border:0px solid #ffffff;color:#ffffff"><span>搜索</span>
                </button>
            </form>
